...
public class EnderTogglerAir extends Block {
	...
	@Override
	public void breakBlock(World world, int x, int y, int z, int meta, int side) {
		super.breakBlock(world, x, y, z, meta, side);
		if (shouldMakeSound)
			world.playSoundEffect(x, y, z, "mob.endermen.portal", 1.0F, 1.0F);
	}
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, int par5) {
		if (!world.isBlockIndirectlyGettingPowered(x, y, z))
			world.setBlock(x, y, z, ModBlocks.enderToggler.blockID, 0, 2);
	}
}
