...
public class Reference {
	...
	public static final String DEPENDENCIES = "required-after:Forge@[9.10.1.849,);after:ThermalExpansion;after:TwilightForest";
	public static final String CHANNEL_NAME = "GanysEnd";
	public static final String MASTER = "GanysMods";
	public static final String VERSION_NUMBER = "1.5.8";
	public static final int RAW_VERSION_NUMBER = 158;
