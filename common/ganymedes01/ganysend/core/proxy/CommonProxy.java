...
public class CommonProxy implements IGuiHandler {
	...
	public void registerTileEntities() {
		...
		GameRegistry.registerTileEntity(TileEntityEnderFurnace.class, Strings.ENDER_FURNACE_NAME);
		GameRegistry.registerTileEntity(TileEntitySolidWaterSource.class, Strings.SOLID_WATER_SOURCE_NAME);
	}
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		switch (ID) {
			...
			case GUIsID.ENDER_FURNACE:
				TileEntityEnderFurnace tileEnderFurnace = (TileEntityEnderFurnace) tile;
				return new ContainerEnderFurnace(player.inventory, tileEnderFurnace);
		}
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		switch (ID) {
			...
			case GUIsID.ENDER_FURNACE:
				TileEntityEnderFurnace tileEnderFurnace = (TileEntityEnderFurnace) tile;
				return new GuiEnderFurnace(player.inventory, tileEnderFurnace);
		}
		return null;
	}
}
